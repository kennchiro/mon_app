      ...
      <div class="flex-none">
        <div class="flex gap-1">
          ...
          <a
            ...
            class={"btn btn-ghost px-6 relative #{if @current_path == "/conversations", do: "border-b-2 border-primary rounded-none", else: ""}"}
          >
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a1.994 1.994 0 01-1.414-.586m0 0L11 14h4a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2v4l.586-.586z" />
            </svg>
            <span :if={@unread_messages_count > 0} class="absolute -top-1 -right-1 badge badge-primary badge-sm text-white">
